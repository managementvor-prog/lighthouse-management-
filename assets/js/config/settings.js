const SETTINGS = {
    siteName: 'Lighthouse Management',
    primaryDomain: 'https://lighthouse-management-xi.vercel.app',
    formSubmitEndpoint: 'https://formsubmit.co/edb3fe2e482a8525f65aa07d71f0f117',
    cloudinaryBase: 'https://res.cloudinary.com/deojrtlep/image/upload/'
};
...
const TALENT_DATA = [
  ...
  },
  {
    id: 13,
    name: "Kevin Costner",
    image: "https://res.cloudinary.com/g9qjxynr/image/upload/v1788304418/IMG-20260901-WA0034.jpg",
    category: "acting",
    bio: "Academy Award-winning American actor, filmmaker, and musician with a career spanning more than five decades.",
    featured: true,
    stats: { projects: 65, awards: 8, experience: "40+ years" },
    specialties: ["Film", "Television", "Directing", "Producing", "Music"],
    availability: "Available",
    rate: "Premium"
  }
];
